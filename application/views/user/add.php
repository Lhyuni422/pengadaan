            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'unit'); ?> value="unit" type="radio" id="unit" name="role" class="custom-control-input">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('unit'); ?>" type="text" id="unit" name="unit" class="form-control" placeholder="Unit">
