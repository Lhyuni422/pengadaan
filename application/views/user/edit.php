            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'pimpinan' ? 'checked' : ''; ?> <?= set_radio('role', 'pimpinan'); ?> value="pimpinan" type="radio" id="pimpinan" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="pimpinan">Pimpinan</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'unit' ? 'checked' : ''; ?> <?= set_radio('role', 'unit'); ?> value="unit" type="radio" id="unit" name="role" class="custom-control-input">
